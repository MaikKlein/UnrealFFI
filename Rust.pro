...
unrealRootPath=/home/maik/projects/UnrealEngine
RustRootPath=/home/maik/Documents/Unreal Projects/Rust

gameProjectFile=/home/maik/Documents/Unreal Projects/Rust/Rust.uproject
...
include(RustSource.pri)
include(RustHeader.pri)
include(RustConfig.pri)
include(RustIncludes.pri)
include(RustDefines.pri)

Rust-Linux-Debug.commands = $$build Rust Linux Debug  -project="\"$$gameProjectFile\"" $$args
Rust-Linux-DebugGame.commands = $$build Rust Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
Rust-Linux-Shipping.commands = $$build Rust Linux Shipping  -project="\"$$gameProjectFile\"" $$args
Rust-Linux-Test.commands = $$build Rust Linux Test  -project="\"$$gameProjectFile\"" $$args
Rust.commands = $$build Rust Linux Development  -project="\"$$gameProjectFile\"" $$args

RustEditor-Linux-Debug.commands = $$build RustEditor Linux Debug  -project="\"$$gameProjectFile\"" $$args
RustEditor-Linux-DebugGame.commands = $$build RustEditor Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
RustEditor-Linux-Shipping.commands = $$build RustEditor Linux Shipping  -project="\"$$gameProjectFile\"" $$args
RustEditor-Linux-Test.commands = $$build RustEditor Linux Test  -project="\"$$gameProjectFile\"" $$args
RustEditor.commands = $$build RustEditor Linux Development  -project="\"$$gameProjectFile\"" $$args
...
QMAKE_EXTRA_TARGETS += \ 
	Rust-Linux-Debug \
	Rust-Linux-DebugGame \
	Rust-Linux-Shipping \
	Rust-Linux-Test \
	Rust \
	RustEditor-Linux-Debug \
	RustEditor-Linux-DebugGame \
	RustEditor-Linux-Shipping \
	RustEditor-Linux-Test \
	RustEditor \
