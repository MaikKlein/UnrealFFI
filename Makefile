...
Rust-Linux-Debug:
	 $(PROJECTBUILD) Rust Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

Rust-Linux-DebugGame:
	 $(PROJECTBUILD) Rust Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

Rust-Linux-Shipping:
	 $(PROJECTBUILD) Rust Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

Rust-Linux-Test:
	 $(PROJECTBUILD) Rust Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

Rust:
	 $(PROJECTBUILD) Rust Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

RustEditor-Linux-Debug:
	 $(PROJECTBUILD) RustEditor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

RustEditor-Linux-DebugGame:
	 $(PROJECTBUILD) RustEditor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

RustEditor-Linux-Shipping:
	 $(PROJECTBUILD) RustEditor Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

RustEditor-Linux-Test:
	 $(PROJECTBUILD) RustEditor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

RustEditor:
	 $(PROJECTBUILD) RustEditor Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)
